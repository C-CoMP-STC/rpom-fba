...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "Robotato/rpom-fba" ]]; then
...
echo "Your new report will be visible at https://Robotato.github.io/rpom-fba in a moment."
